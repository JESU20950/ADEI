...
Si intentemos categorizar todas aquellas variables que en el modelo del apartado anterior nos da resultado. Observamos que el único modelo que da mejor el resultado es aquel con la variable Fare_amount en la que se aplica un polinomio de segundo grado. 
