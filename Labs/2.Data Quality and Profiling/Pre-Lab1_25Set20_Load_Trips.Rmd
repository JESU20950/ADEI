...
# Remove uninformative variablse from data.frame
```
...
names(df)
vars_con<-names(df)[c(10:16,18,24:27)]
vars_con<-names(df)[c(1,4,5,20:21,28)]
...
df$aux<-factor(cut(df$espeed,breaks=c(0,15,19,24,80),include.lowest = T ))
summary(df$aux)
tapply(df$espeed,df$aux,median)
